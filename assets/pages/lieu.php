...
<section class="template-section avant-block">
    <div class="template-container">
        ...
        <br>
        <p class="text animbegintext">Le midi : (li)VE  - Médiacenter de l'université de Franche-Comté, 38 Av. de l'Observatoire, 25000 Besançon</p>
        <p class="text animbegintext">L'après midi : Hall Propédeutique, 43 Avenue de l'Observatoire, 25000 Besançon <i>(Des places de parking <strong>gratuites</strong> sont disponible juste à coté, sur le parc de stationnement de l'université)</i></p>
        <p class="text google" >
        ...
        <br>
        <p class="text">Des ateliers conçues et animés par les étudiants d'informatiques de l'université, serons présentés tout au long de la journée, en voici la liste :</p>
        ...
        <h3>Autres :</h3>
        <br>
        <p class="text">Des pulls ainsi que des écocups aux couleurs de la journée seront disponibles !</p>
