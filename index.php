...
<body>
    ...
    <div class="contenu">
        <section class="main-section">
            ...
            <div id="scrool-bottom">
                <a href="#scrool-bottom"><img loading="lazy" src="./assets/pictures/arrow-down-circle-outline.svg"
        ...
        <section class="template-section">
            <div class="template-container">
                ...
                <p class="text">Cette journée de Recherche et Développement tournera autour du thème de la physique
                    ...
                    opportunités inédites pour façonner l’avenir de l’informatique et des sciences.</p>
                <br>
                <h3>Venez nombreux !</h3>
                <p class="text">
                    Participer à une journée R&D sur la physique quantique et l’informatique peut être bénéfique tant
                    sur le plan professionnel que personnel. Cet événement offre des opportunités d’apprentissage, et
                    d’inspiration, tout en permettant de mieux comprendre les enjeux et les avancées du domaine
                    quantique.</p>
            ...
            <div class="logo-slide-container">
                ...
                <div class="logos-slide">
                    ...
                    <a href="https://ofni.asso.fr/" target="_blank"><img src="./assets/logo/logo-ofni.png"
                            alt="logo association OFNI" title="site OFNI" loading="lazy"></a>
                    <a href="https://www.instagram.com/bdestbesac/" target="_blank"><img
                            src="./assets/logo/logo_bde.png" alt="logo bureau des étudiants UFR ST"
                ...
                <div class="logos-slide">
                    ...
                    <a href="https://ofni.asso.fr/" target="_blank"><img src="./assets/logo/logo-ofni.png"
                            alt="logo association OFNI" title="site OFNI" loading="lazy"></a>
                    <a href="https://www.instagram.com/bdestbesac/" target="_blank"><img
                            src="./assets/logo/logo_bde.png" alt="logo bureau des étudiants UFR STa"
                            title="instagram BDE" loading="lazy"></a>
                    <a href="https://www.instagram.com/besacmi/" target="_blank"><img
                            src="./assets/logo/logo_besacmi.png" alt="logo Besa'CMI" title="instagram Besa'CMI"
                            loading="lazy"></a>
    ...
    <div class="chronometre">
        <div class="corner-round"><img src="./assets/pictures/close.svg" alt="croix pour fermer le minuteur"
                title="fermer" loading="lazy"></div>
    ...
    <div class="to-top-btn">
        <img src="./assets/pictures/arrow-down-circle-outline.svg" alt="bouton pour remonter en haut du site"
            title="remonter" width="50px" height="50px" loading="lazy">
    </div>
    <footer>
